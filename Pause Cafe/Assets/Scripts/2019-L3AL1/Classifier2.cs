...
public class Classifier2 : Classifier{
	...
	public Classifier2(HexaGrid hexaGrid,Character c){
		//Character c = hexaGrid.charList[charID];
		Character target = null;
		foreach(Character character in hexaGrid.charList){
		...
		this.threatAttack = (byte)Classifier2Attributes.intToThreat(AIUtil.AIHard2.threatIfAttack(c));
		this.threatSkill = (byte)Classifier2Attributes.intToThreat(AIUtil.AIHard2.threatIfSkill(c));
		this.threatFlee = (byte)Classifier2Attributes.intToThreat(AIUtil.AIHard2.threatIfFlee(c, target));
		
		this.threatEnemyAttack = (byte)Classifier2Attributes.intToThreat(AIUtil.AIHard2.threatEnemyIfAttack(c));
		this.threatEnemySkill = (byte)Classifier2Attributes.intToThreat(AIUtil.AIHard2.threatEnemyIfSkill(c));
		this.threatEnemyFlee = (byte)Classifier2Attributes.intToThreat(AIUtil.AIHard2.threatEnemyIfFlee(c));
